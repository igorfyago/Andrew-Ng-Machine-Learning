...
#    html = urllib.request.urlopen(url, context=ctx).read()
    #Soup is the flawed html file converted into a cleaner version
    #soup = BeautifulSoup(html, 'html.parser')
    #This is an object which is a mix between a list and a dictionary. We use the position like we do on lists.we use get to retrieve a key, value
    #tags = soup('a')
